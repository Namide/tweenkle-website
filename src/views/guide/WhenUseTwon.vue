...
<template>
  <div class="prose">
    ...
    <p>
      ...
      animations or transitions. For that it's better using CSS animatio or
      transitions and combine transform and opacity modification. The framerate
      and weight will be better.
    </p>
  </div>
</template>
